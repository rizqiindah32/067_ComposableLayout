...
import com.example.pam4.Data.Datasource.status
...
fun TampilForm(cobaViewModel: CobaViewModel = viewModel()){
    ...
    Button(
        modifier = Modifier.fillMaxWidth(),
        onClick = {
            cobaViewModel.insertData(textName, textTlp, textalm, texteml, dataform.sex)
        }
    ){
        Text(
    ...
    TextHasil(namanya = cobaViewModel.namaUsr, telponnya = cobaViewModel.noTlp, emailnya = cobaViewModel.email, alamatnya = cobaViewModel.alamat, jenisnya = cobaViewModel.jenisKl)
}
